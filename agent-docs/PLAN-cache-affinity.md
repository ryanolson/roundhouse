...
| C7 | Shadow classifier (T5) | B4 standalone adapter and multiple-question transport built and mutation-checked under T6. Per-call settlement and current selection snapshots are built and mutation-checked. Rich classification, its durable records, scheduling, and bandit allocation remain open. | `51b0fb2`, `5fba49d`, `42c9991`, `1c14975` |
