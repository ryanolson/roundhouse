...
| C7 | Background classifier (T5) | Rich classification, durable scheduling and delivery, deployment configuration, and evaluation accounting are implemented. Deadline and acknowledgement guards and indexed repair removal have focused mutation evidence. Final runtime publication checks are pending. Frontier feedback and learned allocation remain open. | `438fe2f`, `8269e47`, `a9e7770`, `f62c621`, `3315820` |
