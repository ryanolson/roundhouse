...
Branch: `ai/typesafe-roundhouse-routing-6016d1`. Last update: 2026-09-22. The latest local full run covers `42c9991`: 1807 passed, 0 failed, 145 ignores, across 108 test binaries and 7 doc-test suites. Four new Redis contract instances passed separately against real Redis. No compiler warnings were emitted.
...
| C7 | Shadow classifier (T5) | B4 standalone adapter and multiple-question transport built and mutation-checked under T6. Per-call settlement is built and mutation-checked. Rich classification, runtime records, scheduling, and bandit allocation remain open. | `51b0fb2`, `5fba49d`, `42c9991` |
