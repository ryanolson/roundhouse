...
version: 1.0.0
description: |
  Check documentation and code comments before a commit. Write pull request
  descriptions and issue descriptions. Use this skill only for these three
  pre-commit and description tasks. Do not use it for other documentation,
  comments, messages, or technical text.
license: MIT
